...
% Load Zach's data. I'm pretty sure that he has switched the nd0 and nd0.4
% labels in the data set.
load("/Users/aguirre/Desktop/camera_linearity_ND0_ND0p4_rgb_means.mat")
data = nd04_rgb_means;

% Loop through the R, G, and B sensors and assemble the full measurement
% set. Note that the ND0 and ND0p4 values have been erroneously swapped in
% this data file.
y = [];
for channel = 1:3
