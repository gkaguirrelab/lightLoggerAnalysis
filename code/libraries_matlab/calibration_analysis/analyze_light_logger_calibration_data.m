function [msLinearityFigHandles, ttfFigHandle] = analyze_light_logger_calibration_data(LightLoggerCalibrationData,whichMSChannelsToPlot,msLinearityFigHandles,ttfFigHandle)
%{
