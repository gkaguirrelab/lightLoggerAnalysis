...
%% NEED TO PLACE THIS CODE IN THE CONTEXT OF TBTB. FOR EXAMPLE, NEED
%% THE CALIBRATION OBJECT CODE FOR THIS TO WORK


% Save the path to CombiExperiments. We will use this as a relative
% path to find other files
combiExperiments_path = "~/Documents/MATLAB/projects/combiExperiments";
if ~isfolder(combiExperiments_path)
    combiExperiments_path = "~/Documents/MATLAB/combiExperiments";
end

% Modeling and plotting for a single NDF level
