...
MS_metadata = light_logger_calibration_data.ms_linearity_data.metadata; % will need to be updated if using a different file
MS_parsed_readings = light_logger_calibration_data.ms_linearity_data.readings;
