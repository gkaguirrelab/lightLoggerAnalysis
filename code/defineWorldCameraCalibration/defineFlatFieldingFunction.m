...
README = ['Created by defineFlatFieldingFunction.\n'...
    ...
    'corrR, corrG, corrB -- the correction map separated for each channel.\n'];
derivedVariables = struct();
derivedVariables.correctionMap = correctionMap;
derivedVariables.corrR = corrR;
derivedVariables.corrG = corrG;
derivedVariables.corrB = corrB;
