...
% with >40% spatial saturation, and excluding the first 100 samples
...
% Run the shared fit, save its derived MAT artifact, and retrieve the cleaned
% environmental calibration data for this diagnostic plot.
