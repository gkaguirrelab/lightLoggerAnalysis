...
% Save the measured dark signal value in the "derived" directory for use
% during camera preprocessing
darkSignalValue = median(medianPixelValues);
saveFileName = fullfile(...
    tbLocateProjectSilent('lightLoggerAnalysis'),...
    'derived',...
    'darkSignalValue.mat');
readme = ['Created by defineDarkSignal.\n'...
    'darkSignalValue -- the median dark sensor value across the measured AGC states.\n'];
save(saveFileName,'readme','darkSignalValue');
