...
%
    ...
    for nn = 1:numel(NDFs)
        ...
        sensors = world_linearity_calibration_metadata.sensors_and_settings{nn};
        ...
        for mm = 1:n_measures
            ...
            for setting_idx = 1:numel(settings_scalars_shuffled)
                fprintf("World Camera Linearity | NDF (%d/%d) Setting (%d/%d) Scalar: %.3f M: (%d/%d)\n", ...
                        nn, numel(NDFs),...
                ...
                if(world_linearity_calibration_metadata.completed_measurements(nn, setting_idx, mm))
                    continue;
                end
                ...
                filename = label + sprintf("WorldCameraLinearity_%dsettingsIdx_%dmeasurementIdx", setting_idx, mm);
                ...
                world_linearity_calibration_metadata.completed_measurements(nn, setting_idx, mm) = true;
